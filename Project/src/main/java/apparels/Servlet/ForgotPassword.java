		...
		if (email != null || !email.equals("")) {
			...
			try {
				...
				message.setContent("<h3>Dear Valued "+name+",</h3>\r\n"
						...
						+ "Please contact our 24 hour Call Centre through +94 11 258 5879.<br><br>\r\n"
						+ "\r\n"
						+ "Thank you for using Our Services<br><br>\r\n"
						+ "\r\n"
						+ "This email is automatically generated by the Customer Support Centre. Please do not reply to this email.","text/html");
