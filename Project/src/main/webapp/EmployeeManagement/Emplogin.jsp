                            ...
                            <div class="card card-plain">
                                ...
                                <div class="card-body" id="divcontent">
                                    ...
                                    <form action="../Emplogin" method="post">
                                        <div class="mb-3">
                                            <input type="email" name="login-Email" class="form-control form-control-lg" placeholder="Email" required>
                                        </div>
                                        <div class="mb-3">
                                            <input type="password" name="login-password" class="form-control form-control-lg" placeholder="Password" required>
                                        </div>
                                        <p class="text-muted font-weight-bold">
                                            Password? <a href="forgotPassword.jsp" class=" ml-2">forgot password</a>
                                        </p>
                                        <div class="text-center">
                                            <button type="submit" class="btn btn-lg btn-dark btn-lg w-100 mt-4 mb-0" style="background-color: #B41332;" id="signInbtn">Sign in</button>
