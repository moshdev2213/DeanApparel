...
<body class="g-sidenav-show   bg-gray-100">
	...
	<aside style="z-index: 99; max-width: 16.70rem !important;"
		...
		<div class="collapse navbar-collapse w-auto h-auto"
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a data-bs-toggle="collapse"
					href="#Employee" class="nav-link active"
					aria-controls="ecommerceExamples" role="button"
					aria-expanded="false">
						<div
							class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
					...
					<div class="collapse " id="Employee">
						<ul class="nav ms-4">
							<li class="nav-item active"><a class="nav-link active"
								onclick="brd1()" data-bs-toggle="tab" href="#EmployeeOverview">
									<span class="sidenav-mini-icon text-xs"> N </span> <span
									class="sidenav-normal"> Overview </span>
							</a></li>
							<li class="nav-item"><a class="nav-link " onclick="brd2()"
								data-bs-toggle="tab" href="#TraineeList"> <span
							...
							<li class="nav-item "><a class="nav-link " onclick="brd3()"
								data-bs-toggle="tab" href="#LeaveOverview"> <span
									class="sidenav-mini-icon text-xs"> N </span> <span
									class="sidenav-normal"> Leave </span>
							</a></li>
							<li class="nav-item"><a class="nav-link " onclick="brd4()"
								data-bs-toggle="tab" href="#LeaveType"> <span
									class="sidenav-mini-icon text-xs"> P </span> <span
									class="sidenav-normal"> Leave Type </span>
							</a></li>
							<li class="nav-item"><a class="nav-link " onclick="brd5()"
								data-bs-toggle="tab" href="#OverTime"> <span
									class="sidenav-mini-icon text-xs"> O </span> <span
	...
	<main class="main-content position-relative border-radius-lg ">
				...
				<nav aria-label="breadcrumb">
					<ol
						...
						<li class="breadcrumb-item text-sm text-white active"
							aria-current="page">Employee Management</li>
					</ol>
		...
		<div class="container-fluid p-0 p-md-4">
			<div class="tab-content">
				<div class="tab-pane active" id="EmployeeOverview">
					<div class="row">
	...
	/* background-image: url(assets/img/illustration-barcode_53876-44019.webp); 
				...
				<div class="tab-pane" id="TraineeList">
...
@media ( max-width : 575.98px) {
	...
	.dataTable-dropdown {
		margin-left: 5% !important;
				...
				<div class="tab-pane" id="LeaveOverview">
					<div class="row">
										...
										<table class="table table-flush" id="datatable-basic2">
											...
											<tbody>
												<tr>
													...
													<td class="text-xs font-weight-bold p-0 pt-1">
														<button class="btn btn-outline-dark btn-xs p-1 mb-0"
															data-bs-toggle="modal" data-bs-target="#modal-leave">Deliever</button>
													</td>
				...
				<div class="tab-pane" id="LeaveType">
					<div class="row">
						<div class="col-12">
							<!-- modal of delivery starts -->
							<div class="modal fade " style="z-index: 99999;"
								id="modal-leavetype" tabindex="-1" role="dialog"
								aria-labelledby="modal-form" aria-hidden="true">
								<div class="modal-dialog modal-dialog-centered modal-md"
									role="document">
									<div class="modal-content">
							...
							<div class="card ">
								...
								<div class="card-body p-3">
									...
									<div class="table-responsive" id="tbl_exporttable_to_xls_5">
										<table class="table table-flush" id="datatable-basic3">
											...
											<tbody>
												<tr>
													...
													<td class="text-xs font-weight-bold p-0 pt-1">
														<button class="btn btn-outline-dark btn-xs p-1 mb-0"
															data-bs-toggle="modal" data-bs-target="#modal-leavetype">Deliever</button>
													</td>
				...
				<div class="tab-pane" id="OverTime">
					...
					<div class="row mt-4">
						<div class="col-12">
							<!-- modal of delivery starts -->
							<div class="modal fade " style="z-index: 99999;"
								id="modal-OverTime" tabindex="-1" role="dialog"
								aria-labelledby="modal-form" aria-hidden="true">
								<div class="modal-dialog modal-dialog-centered modal-md"
									role="document">
									<div class="modal-content">
							...
							<div class="card ">
								...
								<div class="card-body p-3">
									...
									<div class="table-responsive" id="tbl_exporttable_to_xls_6">
										<table class="table table-flush" id="datatable-search4">
											...
											<tbody>
												<tr>
													...
													<td class="text-xs font-weight-bold p-0 pt-1">
														<button class="btn btn-outline-dark btn-xs p-1 mb-0"
															data-bs-toggle="modal" data-bs-target="#modal-OverTime">Deliever</button>
													</td>
	...
	<script>
        ...
        function brd2() {
            brd.innerHTML = "Trainee";
        }
        function brd3() {
            brd.innerHTML = "Leave";
        }
        function brd4() {
            brd.innerHTML = "Leave Type";
        }
        function brd5() {
            brd.innerHTML = "Over Time";
        }
    </script>
</body>
