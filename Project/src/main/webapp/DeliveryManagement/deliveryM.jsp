...
List<Delivery> deliveries = deliveryDAO.getAllDeliveriesfMan();

AdminDao adminDao = new AdminDao(DbCon.getConnection());
List<Vehicle> vehicles = adminDao.getallVehiclesM();

List<Driver> drivers = adminDao.getallDriversM();
%>
...
<body class="g-sidenav-show bg-gray-100">
	...
	<aside style="z-index: 99; max-width: 16.70rem !important;"
		...
		<div class="collapse navbar-collapse w-auto h-auto"
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a data-bs-toggle="collapse"
					href="#Delivery" class="nav-link active" aria-controls="Delivery"
					role="button" aria-expanded="false">
						<div
							class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
					...
					<div class="collapse" id="Delivery">
						<ul class="nav ms-4">
							<li class="nav-item"><a class="nav-link active"
								data-bs-toggle="tab" onclick="brd1()" href="#deliveryOverview">
									<span class="sidenav-mini-icon"> O </span> <span
									class="sidenav-normal">OverView<b class="caret"></b></span>
							</a></li>
							<li class="nav-item"><a class="nav-link"
								data-bs-toggle="tab" onclick="brd2()" href="#driverList"> <span
									class="sidenav-mini-icon"> P </span> <span
									class="sidenav-normal"> Driver List <b class="caret"></b></span>
							</a></li>
							<li class="nav-item"><a class="nav-link"
								data-bs-toggle="tab" onclick="brd3()" href="#vehicleList"> <span
									class="sidenav-mini-icon"> P </span> <span
	...
	<main class="main-content position-relative border-radius-lg">
				...
				<nav aria-label="breadcrumb">
					<ol
						...
						<li class="breadcrumb-item text-sm text-white "
							aria-current="page">Delivery Management</li>
					</ol>
				...
				<div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0 me-sm-4"
					...
					<ul class="navbar-nav justify-content-end">
						...
						<li class="nav-item dropdown pe-2 d-flex align-items-center">
							...
							aria-expanded="false">
								<div
									style="width: 40px; height: 40px; background-image: url('../assets/img/team-1.jpg'); background-repeat: no-repeat; background-size: cover; border-radius: 200px;"></div>
						</a>
		...
		<div class="container-fluid py-4">
			<div class="tab-content">
				<div class="tab-pane active" id="deliveryOverview">
									...
									<table class="table table-flush" id="datatable-search">
										...
										<tbody>
											...
											<tr>
												...
												<td class="font-weight-bold"><span class="my-2 text-xs"><%=d.getDate()%></span>
												</td>
												...
												<td class="text-xs font-weight-bold">
													<div class="d-flex align-items-center">
														<img src="../assets/img/<%=d.getPropic()%>"
															class="avatar avatar-xs me-2" alt="user image"> <span><%=d.getCname()%></span>
													</div>
												</td>
												<td class="text-xs font-weight-bold"><span
													class="my-2 text-xs"><%=d.getName()%></span></td>
												<td class="text-xs font-weight-bold"><span
													class="my-2 text-xs"><%=d.getNote()%></span></td>
											...
											<tr>
												<td>
													<div class="d-flex align-items-center">
														...
														<p class="text-xs font-weight-bold ms-2 mb-0"><%=d.getId()%></p>
													</div>
												</td>
												<td class="font-weight-bold"><span class="my-2 text-xs"><%=d.getEmail()%></span>
												</td>
												<td class="text-xs font-weight-bold">
													<div class="d-flex align-items-center">
														<button
												...
												<td class="text-xs font-weight-bold">
													<div class="d-flex align-items-center">
														<img src="../assets/img/<%=d.getPropic()%>"
															class="avatar avatar-xs me-2" alt="user image"> <span><%=d.getFullname()%></span>
													</div>
												</td>
				...
				<div class="tab-pane " id="vehicleList">
					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-header pb-0">
									<div class="d-lg-flex">
										<div>
											...
											<p class="text-sm mb-0">Delivery vehicle</p>
										</div>
												...
												<tr>
													<td>
														<div class="d-flex">
															...
															<img class="w-20 ms-3"
																src="../assets/img/Vehicle/<%=v.getVimg()%>"
																alt="hoodie">
															<h6 class="ms-3 my-auto"><%=v.getVname()%></h6>
														</div>
													</td>
													<td class="text-sm"><%=v.getAvaiFuel()%>L</td>
													<td class="text-sm"><%=v.getAvgSpeed()%></td>
													<td class="text-sm"><%=v.getChasisNo()%></td>
													<td class="text-sm"><%=v.getMileage()%></td>
													<td><span class="badge badge-danger badge-sm"><%=v.getBatteryHealth()%></span>
													</td>
	...
	<script>
		...
		function brd2() {
			brd.innerHTML = "Driver List";
		}
		function brd3() {
			brd.innerHTML = "Vehicle List";
		}
	</script>
	<!-- Github buttons -->
