		...
		<div class="collapse navbar-collapse  w-auto h-auto"
			...
			<ul class="navbar-nav">
				...
				<li class="nav-item"><a href="#" class="nav-link active">
						...
						</div> <span class="nav-link-text ms-1">WhishList</span>
				</a></li>
			</ul>
		</div>
	</aside>
		...
		<nav
			...
			<div class="container-fluid py-1 px-3">
				<nav aria-label="breadcrumb">
					...
					<h6 class="font-weight-bolder mb-0 text-white">WhishList</h6>
				</nav>
				<div
					...
					<div class="card" id="jqueryrefresh">
						<div class="card-body">
							...
							if (authin != null) {
								...
								WishDao cdao = new WishDao(DbCon.getConnection());
								List<WhishList> crt = cdao.fetchWish(authin.getEmail());
								crt = cdao.fetchWish(authin.getEmail());

								if (crt.isEmpty()) {
							%>
							<h1 class="shadow-none text-black bold text-center">WhishList
								IS EMPTY</h1>
											...
											<tbody>
												...
												<tr>
													...
													<td class="align-middle text-center"><span
														class="text-secondary text-sm"> <input
															type="hidden" id="authmail"
															value="<%=authin.getEmail()%>" /> <input type="hidden"
															id="pid" value="<%=c.getId()%>" /> 
														<a
															class="btn btn-link text-danger text-gradient px-3 mb-0 removewish" data-id="<%=c.getId()%>"><i
																class="far fa-trash-alt me-2 "></i>Delete </a> <a
															class="btn btn-link text-primary text-gradient px-3 mb-0 ad2wish" data-id="<%=c.getId()%>"><i
																class="fas fa-shopping-cart text-dark me-2"
								...
								<div class="col-md-6">
									<div class="row mb-5">
										<div class="col-md-6 mb-3 mb-md-0">
											<a href="Cart.jsp" class="btn btn-primary btn-lg w-100">View
												Cart</a>
										</div>
										<div class="col-md-6">
				...
				Swal.fire({
					  ...
					  if (result.isConfirmed) {
						  $.ajax({
								type : 'GET',
								url : '../RemoveWishlist',
								data : "removeid=" + $(this).attr("data-id") + "&email=" + $('#authmail').val(),
