...
<%
FinancialDao cpd = new FinancialDao(DbCon.getConnection());
List<CusFinancial> Financiallist = cpd.getFinance();

//-------------get sup data

SupplierDao sda = new SupplierDao(DbCon.getConnection());
List<GrnPay> supdet = sda.getAllsupdata();
	...
	<main class="main-content position-relative border-radius-lg ">
		...
		<div class="container-fluid p-0 p-md-4" style="overflow: hidden;">
			<div class="tab-content">
				...
				<div class="tab-pane active" id="StaffAttendence">
					<div class="row">
						<div class="col-12">
							<div class="card">
								...
								<div class="card-body px-0 pb-0">
									<div class="table-responsive" id="tbl_exporttable_to_xls_1">
										<table class="table" id="datatable-search1">
											...
											<tbody>
												<%
												for (CusFinancial sp :Financiallist) {
												%>
												<tr>
													<td>
														<div class="d-flex">

															<h6 class="ms-3 my-auto"><%=sp.getUsermali() %></h6>
														</div>
													</td>
													<td class="text-sm"><%=sp.getPayment_id() %></td>
													<td class="text-sm"><%=sp.getCnumber() %></td>
													<td class="text-sm"><%=sp.getSubtotal() %></td>
													<td class="text-sm"><%=sp.getTotal() %></td>
													<!--  <td><span class="badge badge-danger badge-sm">Out
															of Stock</span></td>-->
													<td class="text-sm">
	 <a href="../StaffM.jsp" > action
