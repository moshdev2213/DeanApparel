					...
					<div class="row">
						<div
							...
							<div class="card card-plain">
								<div class="card-header pb-0 text-left">
									...
									<p class="mb-0">Enter Your NeW Password That You Want To Change With Confirmation</p>
								</div>
								<div class="card-body">
									<form action="forgotPassword" method="POST">
										<div class="mb-3">
											<input type="password" class="form-control form-control-lg"
												placeholder="Enter New Password" aria-label="name" />
										</div>
										<div class="mb-3">
											<input type="password" class="form-control form-control-lg"
												placeholder="Enter Password Confirmation" aria-label="code" />
										</div>
						...
						<div
							...
							<div
								...
								style="background-image: url('assets/img/illustrations/succeed.jpg'); background-size: cover;">
