...
<a href ="payment_insert.jsp"> <button type="submit" class="btn wow bounceInRight" data-wow-delay="0.8s">Add payment</button></a> 
 <a href ="Search_payment.jsp"> <button type="submit" class="btn wow bounceInRight" data-wow-delay="0.8s">Edit </button></a>
...
String connectionUrl = "jdbc:mysql://localhost:3306/dean_apparels";
String userId = "root";
String password = "#True12345";
